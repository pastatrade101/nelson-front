  ...
  <div class="fixed inset-0 z-50 grid place-items-center bg-black/45 p-4 backdrop-blur-sm" transition:fade={{ duration: 140 }}>
    ...
    >
      ...
      <div class="mt-6 grid gap-4">
        ...
        <div class="grid gap-4 sm:grid-cols-2">
          <MediaPicker label="Hero image" media={$mediaLibrary} uploadFolder="trip-points" bind:value={form.hero_image_url} />
          <MediaPicker label="Card image" media={$mediaLibrary} uploadFolder="trip-points" bind:value={form.image_url} />
        </div>
