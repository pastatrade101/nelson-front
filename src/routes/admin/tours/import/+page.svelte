<script lang="ts">
  ...
  const EXAMPLE = [
    ...
    'safari', 'classic', '7', '6', '3500', 'USD', '2', '6', '6', 'Easy', 'Arusha', 'Arusha',
    ...
    'Standard~3500~per_person~Classic lodges, 7 nights 2 pax sharing||Signature~5500~per_person~Premium tented camps||Prestige~9000~per_person~Singita, Ngorongoro Crater Lodge'
  ];
...
<div class="mt-6 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
  ...
  <section class="rounded-2xl border border-ink/10 bg-surface p-6 shadow-sm">
    ...
    <ul class="mt-4 grid gap-2.5 text-sm text-ink/75">
      ...
      <li><code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">price_options</code> — each tier <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">label~price~price_type~notes</code>, tiers separated by <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">||</code>. <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">price_type</code>: <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">per_person</code> / <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">per_group</code> / <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">per_child</code> / <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">single_supplement</code> / <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">upgrade</code> / <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">discount</code> (default <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">per_person</code>).</li>
      <li><code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">budget_tier</code> — comfort tier: <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">essential</code> / <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">classic</code> / <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">luxury</code> / <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">ultra_luxury</code> (older values like <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">budget</code>/<code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">mid_range</code> are auto-converted).</li>
      <li><code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">experience_type</code> / <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">difficulty_level</code> — free text (e.g. <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">safari</code>, <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">safari-beach</code> / <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">Easy</code>, <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">Moderate</code>, <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">Challenging</code>).</li>
      <li><code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">is_featured</code> / <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">is_popular</code> — <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">true</code> or <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">false</code>. <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">currency</code> is a 3-letter code (e.g. <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">USD</code>); numbers are plain digits.</li>
      <li><code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">status</code> — <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">draft</code> / <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">published</code> / <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">archived</code> (default <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">draft</code>). Only <code class="rounded bg-sand px-1.5 py-0.5 font-mono text-xs">title</code> is required.</li>
    </ul>
  </section>
</div>
