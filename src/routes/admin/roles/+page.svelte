...
<div class="mx-auto grid w-full max-w-[1500px] gap-6">
  <div class="rounded-none border border-ink/10 bg-surface/70 p-6 shadow-[0_18px_50px_rgba(28,26,22,0.06)]">
  ...
  {:else}
    <div class="grid gap-4 lg:grid-cols-2">
      {#each roles as role (role.role)}
        <article class="grid gap-4 rounded-none border border-ink/10 bg-surface p-5 shadow-[0_14px_44px_rgba(28,26,22,0.06)]">
