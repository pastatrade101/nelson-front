...
export const EXPERIENCE_INFO: Record<string, ExperienceInfo> = {
  safari: {
    whoItsFor: 'First-timers, families and photographers — anyone who wants the iconic Tanzania wildlife experience.',
  ...
  kilimanjaro: {
    ...
    highlights: ['Uhuru Peak (5,895m)', 'Machame & Lemosho routes', 'Glaciers & alpine desert', 'Expert Arusha mountain crew']
  },
  'beach-holiday': {
